...
% Alle drei Teil-Laborbücher in einer chronologischen Tabelle
% ============================================================

\ssSetDocTitle{Laborbuch}
\ssSetKunde{Bildungsministerium NRW}
\ssSetProjekt{SafetySpot}
\ssSetAutoren{D0rag3on, IIRu5hII, 0qln}
...
Dieses Dokument vereint die Laborbuecher aller drei Projektteilnehmer.
Die Eintraege sind rein chronologisch sortiert und nicht nach Autor getrennt.
Die Formatierung orientiert sich an der Ru5h-Vorlage, das Layout an der SafetySpot-Stildatei.

\section{Chronologische Laborbuch-Eintraege}
...
2026-06-10 & IIRu5hII & Ziel &
  ...
  \newline\textit{Ergebnis:} Rekonstruiert aus Codezustand und Autorenaussage (kein Commit).
\\
...
\textbf{D0rag3on:} Backend-Grundlage, Authentifizierung, Fehlerbehandlung und School-/Klassen-Verwaltung.

\textbf{IIRu5hII:} Android-Frontend mit Compose, Mockdaten, Navigation, Gameplay, Ranking und Profil.

\textbf{0qln:} Infrastruktur, Backend-APIs, CI/CD, Demo-Daten, Bildverwaltung und Mobile-Clickdummy.

\textbf{Gesamt:} SafetySpot ist als Backend, Mobile-Prototyp und Projektinfrastruktur zusammengewachsen.
